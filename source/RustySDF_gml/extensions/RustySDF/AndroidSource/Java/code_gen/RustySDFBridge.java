...
public final class RustySDFBridge {
    ...
    public static native double __EXT_JNI__rusty_sdf_load_font(ByteBuffer buffer_ptr, double buffer_len);
    ...
    public static native String __EXT_JNI__rusty_sdf_get_shape_glyph_info(double shape_handle, double index);
    public static native String __EXT_JNI__rusty_sdf_get_shape_glyphs_json(double shape_handle);
    ...
    public static native String __EXT_JNI__rusty_sdf_get_glyph_bounds(double font_handle, double glyph_id, double font_size);
    public static native double __EXT_JNI__rusty_sdf_get_glyph_bounds_buffer(double font_handle, double glyph_id, double font_size, ByteBuffer buffer_ptr);
    ...
    public static native String __EXT_JNI__rusty_sdf_poll_glyph();
    public static native double __EXT_JNI__rusty_sdf_poll_glyph_buffer(ByteBuffer buffer_ptr, double buffer_len);
    public static native double __EXT_JNI__rusty_sdf_poll_glyph_pixels(ByteBuffer buffer_ptr, double buffer_len);
    public static native double __EXT_JNI__rusty_sdf_poll_glyph_pixels_strided(ByteBuffer buffer_ptr, double buffer_len, double stride_w, double stride_h);
    public static native String __EXT_JNI__rusty_sdf_measure_text(double font_handle, String text, double font_size);
    ...
    public static native double __EXT_JNI__rusty_sdf_atlas_prepare_lookup(double font_handle, double glyph_id, double base_size, double spread);
    public static native double __EXT_JNI__rusty_sdf_atlas_lookup_buffer(ByteBuffer buffer_ptr, double buffer_len);
    ...
    public static native double __EXT_JNI__rusty_sdf_atlas_poll_dirty_meta(ByteBuffer buffer_ptr, double buffer_len);
    public static native double __EXT_JNI__rusty_sdf_atlas_poll_dirty_pixels(ByteBuffer buffer_ptr, double buffer_len);
